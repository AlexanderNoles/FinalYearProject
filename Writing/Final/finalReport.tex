...
PMI also handles the drawing of the Interaction Cursor on the map for map enabled \textbf{Interactions}. These include a border highlight mode, a cell selection mode and a line indicator. Interactions are an essential part of the general gameplay loop and are discussed below.
