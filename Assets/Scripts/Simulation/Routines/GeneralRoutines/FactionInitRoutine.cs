...
[SimulationManagement.ActiveSimulationRoutine(3000, true)]
public class FactionInitRoutine : InitRoutineBase
{
    ...
    public override void Run()
    {
        ...
        if (nextID == -1)
        {
            //This only occurs the first time an id needs to be assigned this game session
